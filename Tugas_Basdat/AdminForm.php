...
<body>
	...
	<center>
		<ul>
			...
			<li><a class="link" href="#">Isi Data</a></li>
			<li class="dropdown">
		...
		<form method="post" action="sendform.php">
				<table>
					...
					<tr>
					<td>Asal</td>
					<td><input type="text" name="Asal" maxlength="20" onkeypress="return onlyAlphabets(event)" required></td>
					</tr>
					
					<tr>
					<td>Tanggal Lahir</td>
					<td><input type="date" name="Tanggal" min="1990-01-01" max="2000-12-31" required></td>
					</tr>	
					
					<tr>
					<td>Dosen Wali</td>
					<td><select name="Doswal" required>
						<?php				
